...
#    define RETRO_TAPPING_PER_KEY "yes"
#    define RGBLIGHT_LAYERS "yes"
#endif
...
enum custom_keycodes { NAV_V = SAFE_RANGE, NAV_O, NAV_CAPS, QW_PRN };
 ...
 */
    [_QWERTY] = LAYOUT(
     ...
     QW_PRN ,  KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,   KC_B , KC_LBRC, KC_MEH,      FKEYS  , KC_RBRC,  KC_N,   KC_M ,KC_COMM, KC_DOT ,KC_SLSH, KC_BSLS,
 ...
 */
    [_SYM] = LAYOUT(
     ...
     KC_PIPE , KC_BSLS, KC_COLN, KC_SCLN, KC_MINS, KC_LBRC, KC_LCBR, XXXXXXX,      XXXXXXX, KC_RCBR, KC_RBRC, KC_UNDS, KC_LT,   KC_GT,   KC_SLSH, KC_QUES,
                              G(KC_KP_0), _______, KC_LCTL, KC_0,    _______,      _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    ),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    if (keycode == QW_PRN && record->event.pressed) {
      uint8_t mod_state = get_mods();
      mod_state & MOD_MASK_SHIFT ? tap_code16(KC_RPRN) : tap_code16(KC_LPRN);
      return false;
    }
